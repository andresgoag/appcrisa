        ...
        .then((data) => {
            ...
            for (let i = 0; i < data["ordenes"].length; i++) {
                ...
                if (
                    ...
                    let checkbox_despachado = document.getElementById(
                        `check_despachado_${i}`
                    );
                    ...
                    checkbox_despachado.addEventListener(
                        "click",
                        checkDespacho
                    );
                }
...
const checkDespacho = (evento) => {
    ...
    if (evento.target.checked) {
        confirmation = confirm(
            "Desea marcar esta orden como despachada? Esta acción es irreversible"
        );
